          ...
          <div className="container max-w-4xl mx-auto px-6">
            ...
            >
              ...
              <div className="max-w-2xl space-y-4 text-slate-400 leading-relaxed mb-14">
                <p>
                  Webサービス、スポーツDX、新規プロダクトの開発を経験した後に独立。
                </p>
                <p>
                  現在は、自社スポーツAIプロダクトの企画・開発・運営と並行して、スタートアップや新規事業チームの開発顧問・技術支援を行っています。Web・モバイル・バックエンド・クラウド・AIを横断し、要件整理やアーキテクチャ設計から実装まで担当します。
                </p>
              </div>
